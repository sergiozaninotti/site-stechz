...
class Teacher_model extends CI_Model
{
    ...
    var $column_search = array("teacher_name", "teacher_description"); // variavel global da classe que recebe as colunas onde serão feito as buscas pelo datatable
    var $column_order = array("teacher_name",); // variavel recebe os campos do db que pegara a ordem de duração, seguindo a sequencia que esta no banco de dados
    ...
    { // função privada que é utilizada somente por outras funções aqui no model
        ...
        $this->db->from("teacher"); // seleciona da onde vai pegar a informação
    ...
    { // lista quantos dados tem no db e quantos esta mostrando naquela busca
        $this->db->from("teacher"); // seleciona o db e a tabela
