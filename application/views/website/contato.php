    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-11 mx-auto">
                <div class="col-md-4 text-center purple d-inline-block wow fadeIn">
                    <h3>Contato</h3>

                    <form method="post" class="mt-4 contact_form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="whatsapp" class="form-control" id="whatsapp" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="">Mensagem</label>
                            <textarea class="form-control" name="mensagem" id="" rows="4" placeholder=""></textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Não sou um Robô</label>
                            <div class="g-recaptcha" name="recaptcha" data-sitekey="6Lc_JbgUAAAAAB-CSCHe2YwAPOxXFocACh6GC78C" style="transform: scale(0.825) !important;
    -webkit-transform: scale(0.85) !important;
    transform-origin: center !important;
    -webkit-transform-origin: center;"></div>
                        </div>
                ...
                <div class="col-md-7 d-inline-block float-right">
                    <h2 class="wow fadeIn" data-wow-delay="0.5s">Sua empresa merece um site único! Mande nos uma mensagem agora.</h2>
                    <p class="mb-4 wow fadeIn" data-wow-delay="0.75s">Nossa paixão é desenvolver sites criativos com alto padrão de design e desempenho, além disto, focamos na experiência que o usuário terá interagindo com sua marca.</p>
                    <div class="col-lg-12 mt-3 pt-3 pl-0 contact-icons">
                        <div class="col-sm-2 d-inline-block pl-0 text-center wow fadeIn" data-wow-delay="0.75s"><img class="d-block mb-2 mx-auto" src="<?= base_url('assets/website/img/icons/magic.png'); ?>" alt="">Design</div>
                        <div class="col-sm-3 d-inline-block wow fadeIn" data-wow-delay="1s"><img class="d-block mb-2 mx-auto" src="<?= base_url('assets/website/img/icons/rocket.png'); ?>" alt="">Desempenho</div>
                        <div class="col-sm-3 d-inline-block text-center pl-0 wow fadeIn" data-wow-delay="1.25s"><img class="d-block mb-2 mx-auto"  src="<?= base_url('assets/website/img/icons/idea.png'); ?>" alt="">Inovação</div>
                        <div class="col-sm-3 d-inline-block pl-0 wow fadeIn" data-wow-delay="1.5s"><img class="d-block mb-2 ml-4" src="<?= base_url('assets/website/img/icons/smile.png'); ?>" alt="">Experiência</div>
                    </div>
                    <div class="col-md-12 d-inline-block mt-5">
                        <h3 class="wow fadeIn" data-wow-delay="1.75s">Pagamento facilitado no cartão:</h3> <small>Para outras condições, consulte nosso setor comercial.</small>
                        <img class="w-50 wow fadeIn" data-wow-delay="1.75s" src="<?= base_url('assets/website/img/payments.png') ?>">
                    </div>
                </div>
            </div>
